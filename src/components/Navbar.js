        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex-shrink-0">
            <div className="relative group cursor-pointer">
              <div className={`absolute inset-0 bg-gradient-to-r ${theme.gradients.primary} rounded-xl blur-md opacity-70 group-hover:opacity-100 transition-opacity duration-300`}></div>
              <div className={`relative w-12 h-12 bg-gradient-to-br ${theme.gradients.primary} rounded-xl flex items-center justify-center ${theme.shadows.lg} transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}>
                <span className={`${theme.text.white} font-black text-xl`}>MF</span>
              </div>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-2 absolute left-1/2 transform -translate-x-1/2">
            ...
            <div className="relative">
              ...
              <div 
                onMouseEnter={() => setDownloadOpen(true)}
                onMouseLeave={() => setDownloadOpen(false)}
                className={`absolute top-full left-1/2 -translate-x-1/2 mt-2 ${theme.backgrounds.white} ${theme.shadows.xl} rounded-2xl py-3 w-64 ${theme.borders.light} border transition-all duration-300 origin-top ${
                  downloadOpen 
          ...
          <div className="hidden lg:flex items-center">
            <div className="relative">
              ...
              <div 
                className={`absolute top-full right-0 mt-2 ${theme.backgrounds.white} ${theme.shadows.xl} rounded-xl py-2 w-48 ${theme.borders.light} border transition-all duration-300 origin-top-right ${
                  languageOpen 
                    ? 'opacity-100 scale-100 translate-y-0' 
                    : 'opacity-0 scale-95 -translate-y-2 pointer-events-none'
                }`}
