    ...
    <section className="py-16 md:py-20 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-5 py-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-full text-sm font-semibold mb-4 shadow-lg">
            <TrendingUp className="w-4 h-4" />
            Our Impact
          </div>
          <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-3">
            Numbers That <span className="bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">Speak</span>
          </h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">
            Trusted by thousands of defense aspirants across the nation
          </p>
        </div>
