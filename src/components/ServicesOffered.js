  ...
  const services = [
    {
      ...
      features: [
        ...
        t.serviceTalkFeature3,
        t.serviceTalkFeature4,
        t.serviceTalkFeature5
      ],
      gradient: theme.gradients.primary,
      bgGradient: theme.backgrounds.primary,
      accentColor: "orange",
      stats: { label: t.serviceTalkStats, value: "500+" }
    },
    {
      id: 2,
      icon: Users,
      title: t.serviceMentorshipTitle,
      description: t.serviceMentorshipDesc,
      features: [
        t.serviceMentorshipFeature1,
        t.serviceMentorshipFeature2,
        t.serviceMentorshipFeature3,
        t.serviceMentorshipFeature4,
        t.serviceMentorshipFeature5
      ],
      gradient: theme.gradients.primaryLight,
      bgGradient: theme.backgrounds.primary,
      accentColor: "orange",
      stats: { label: t.serviceMentorshipStats, value: "" }
    },
    {
      id: 3,
      icon: Target,
      title: t.serviceConsultTitle,
      description: t.serviceConsultDesc,
      features: [
        t.serviceConsultFeature1,
        t.serviceConsultFeature2,
        t.serviceConsultFeature3,
        t.serviceConsultFeature4,
        t.serviceConsultFeature5
      ],
      gradient: theme.gradients.warm,
      bgGradient: theme.backgrounds.primary,
      accentColor: "orange",
      stats: { label: t.serviceConsultStats, value: "10+" }
    }
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus({ 
        loading: false, 
        success: false, 
        error: error.message || t.bookingError
      });
    }
  };
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className={`text-4xl md:text-5xl font-black ${theme.text.primary} mb-4`}>
            {t.servicesTitle} <span className={`bg-gradient-to-r ${theme.gradients.primary} bg-clip-text text-transparent`}>{t.servicesHighlight}</span>
          </h2>
          ...
          <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className={`bg-gradient-to-r ${selectedService.gradient} p-6 relative`}>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-2xl font-black text-white">{t.bookService}</h3>
            ...
            <div className="p-8">
              {status.success ? (
                <div className="text-center py-8">
                  ...
                  <h4 className="text-2xl font-bold text-gray-900 mb-2">{t.bookingSuccess}</h4>
                  <p className="text-gray-600">{t.bookingSuccessMsg}</p>
                </div>
              ) : (
                <div className="space-y-5">
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">{t.formOrganization}</label>
                    <input 
                      type="text"
                      name="organization"
                  ...
                  <div>
                    <label className="block text-sm font-bold text-gray-700 mb-2">{t.formPreferredDate}</label>
